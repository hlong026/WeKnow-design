export default {
  ...
  settings: {
    ...
    backup: {
      title: "备份与恢复",
      description: "导出或导入数据库数据，用于数据备份、迁移或恢复",
      export: "数据导出",
      import: "数据导入",
      selectData: "选择要导出的数据",
      selectAll: "全选",
      ...
      importBtn: "导入数据",
      dropFile: "点击或拖拽文件到此处",
      supportFormat: "支持 .zip 格式的备份文件",
      skipExisting: "跳过已存在的记录",
      clearFile: "清除文件",
  ...
  upload: {
    ...
    uploadFolder: "上传文件夹",
    onlineEdit: "在线编辑",
    socialMediaImport: "导入社媒文案",
    deleteRecord: "删除记录",
  },
  socialMedia: {
    importTitle: "导入社媒文案",
    selectPlatform: "选择平台",
    selectPlatformPlaceholder: "请选择社交媒体平台",
    videoUrl: "视频链接",
    videoUrlPlaceholder: "请输入小红书或抖音的视频链接",
    urlHint: "支持小红书笔记链接和抖音视频链接",
    importing: "正在提取文案...",
    selectPlatformFirst: "请先选择平台",
    enterUrlFirst: "请输入视频链接",
    importSuccess: "文案导入成功",
    importFailed: "文案导入失败",
    apiNotImplemented: "API接口待实现，请稍后提供调用指令",
    platforms: {
      xiaohongshu: "小红书",
      douyin: "抖音",
    },
  ...
  knowledgeEditor: {
    ...
    integration: {
      title: "集成配置",
      description: "配置第三方服务集成，用于扩展知识库功能",
      aliyunApiKeyLabel: "阿里云 API Key",
      aliyunApiKeyPlaceholder: "请输入阿里云 API Key（用于自媒体文案提取）",
      aliyunApiKeyTip: "用于调用 Coze workflow API 提取自媒体文案内容，支持小红书、抖音等平台",
    },
    buttons: {
      create: "创建知识库",
      save: "保存配置",
  ...
  modelSettings: {
    ...
    credential: {
      title: "凭证配置",
      name: "凭证名称",
      namePlaceholder: "为此凭证起个名字，便于识别",
      apiKey: "API Key",
      apiKeyPlaceholder: "请输入 API Key",
      baseUrl: "API 端点",
      baseUrlPlaceholder: "留空使用默认端点",
      baseUrlHelp: "自定义 API 端点，留空使用官方默认地址",
      isDefault: "设为默认凭证",
      quota: "配额限制",
      quotaOptional: "配额限制 (可选)",
      dailyLimit: "每日限制",
      monthlyLimit: "每月限制",
      testConnection: "测试连接",
      testSuccess: "连接测试成功",
    ...
    toasts: {
      ...
      credentialDeleted: "凭证删除成功",
      credentialTestSuccess: "连接测试成功",
      credentialTestFailed: "连接测试失败",
    },
    confirmDelete: "确定删除此模型吗？",
    confirmDeleteCredential: "确定删除此凭证吗？删除后关联的模型将无法使用。",
  },
  // 新增：Ollama 设置
  ollamaSettings: {
    title: "Ollama 配置",
