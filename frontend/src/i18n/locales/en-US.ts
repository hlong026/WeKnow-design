export default {
  ...
  settings: {
    ...
    backup: {
      ...
      description: 'Export or import database data for backup, migration, or recovery',
      export: 'Data Export',
      import: 'Data Import',
      ...
      dropFile: 'Click or drag file here',
      supportFormat: 'Supports .zip backup files',
...
\
  ...
  globalSearch: {
    ...
    button: 'Search',
    placeholder: 'Enter keywords to search knowledge base content...',
    searching: 'Searching...',
