export default {
  ...
  settings: {
    ...
    backup: {
      title: "백업 및 복원",
      description: "데이터베이스 데이터를 내보내거나 가져와 백업, 마이그레이션 또는 복구에 사용",
      export: "데이터 내보내기",
      import: "데이터 가져오기",
      selectData: "내보낼 데이터 선택",
      selectAll: "전체 선택",
      deselectAll: "전체 해제",
      exportBtn: "데이터 내보내기",
      importBtn: "데이터 가져오기",
      dropFile: "파일을 클릭하거나 여기로 드래그",
      supportFormat: ".zip 형식의 백업 파일 지원",
      skipExisting: "기존 레코드 건너뛰기",
      clearFile: "파일 지우기",
