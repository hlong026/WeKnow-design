export default {
  ...
  settings: {
    ...
    backup: {
      ...
      description: 'Экспорт или импорт данных базы данных для резервного копирования, миграции или восстановления',
      export: 'Экспорт данных',
      import: 'Импорт данных',
      selectData: 'Выберите данные для экспорта',
      selectAll: 'Выбрать все',
      deselectAll: 'Снять выбор',
      exportBtn: 'Экспортировать',
      importBtn: 'Импортировать',
      dropFile: 'Нажмите или перетащите файл сюда',
      supportFormat: 'Поддерживаются файлы .zip',
      skipExisting: 'Пропустить существующие записи',
      clearFile: 'Очистить файл',
      exportSuccess: 'Данные успешно экспортированы',
      exportFailed: 'Не удалось экспортировать данные',
      importSuccess: 'Импорт данных завершён',
      importFailed: 'Не удалось импортировать данные',
      importResult: 'Результат импорта',
      importErrors: 'При импорте возникли следующие ошибки',
      knowledgeBases: 'Базы знаний',
      knowledge: 'Элементы знаний',
